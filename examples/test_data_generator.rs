...
fn generate_complex_regression(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
...
fn generate_regression_with_missing(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
...
fn generate_mixed_regression(
    ...
    println!(
        "  Generated: {} ({} numerical, {} categorical)",
        filename, n_numerical, n_categorical
    );
    Ok(())
}
...
fn generate_binary_classification(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
    ...
    for i in 0..n_samples {
        ...
        labels[i] = if rng.gen::<f32>() < probability {
            1.0
        } else {
            0.0
        };
...
fn generate_imbalanced_binary(
    ...
    println!(
        "  Generated: {} (imbalanced: {:.1}% minority)",
        filename,
        minority_ratio * 100.0
    );
    Ok(())
}

fn generate_multiclass_classification(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
...
fn generate_mixed_classification(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_numerical: usize,
    ...
    for i in 0..n_samples {
        ...
        for j in 0..n_numerical {
            ...
            features[[i, j]] = Normal::new(class_offset as f64, 1.0)
                .unwrap()
    ...
    println!(
        "  Generated: {} ({} classes, {} numerical, {} categorical)",
        filename, n_classes, n_numerical, n_categorical
    );
    Ok(())
}
...
fn generate_high_dimensional(
    ...
    save_regression_csv(output_dir, filename, &features, &labels, None, n_features)?;
    println!(
        "  Generated: {} (high dimensional: {} features, {} informative)",
        filename, n_features, n_informative
    );
    Ok(())
}

fn generate_extreme_values(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
...
fn generate_constant_features(
    ...
    save_regression_csv(output_dir, filename, &features, &labels, None, n_features)?;
    println!(
        "  Generated: {} ({} constant features)",
        filename, n_constant
    );
    Ok(())
}

fn generate_correlated_features(
    output_dir: &Path,
    filename: &str,
    n_samples: usize,
    n_features: usize,
    ...
    for i in 0..n_samples {
        ...
        for j in 1..n_features {
            let correlation = 0.8;
            let noise = Normal::new(0.0, (1.0 - correlation * correlation).sqrt())
                .unwrap()
                .sample(&mut rng) as f32;
...
fn save_regression_csv_with_missing(
    output_dir: &Path,
    filename: &str,
    features: &Array2<f32>,
    labels: &Array1<f32>,
...
fn save_mixed_classification_csv(
    output_dir: &Path,
    filename: &str,
    features: &Array2<f32>,
    labels: &Array1<f32>,
